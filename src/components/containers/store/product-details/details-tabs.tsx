...
export default function ProductDetailsTabs({
  ...
  console.log("attributeIds:", product.attributeIds);
  console.log("attributeNames:", product.attributeNames);
  console.log("attributeValues:", product.attributeValues);
  console.log("attributeValueNames:", product.attributeValueNames);
